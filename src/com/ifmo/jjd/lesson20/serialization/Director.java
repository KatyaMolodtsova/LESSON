...
public class Director extends Human implements Externalizable {
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        // описание свойств, которые передаются в сериализацию
        out.writeUTF(speech); // запись строки
        out.writeInt(rating);
        out.writeInt(age);
        //out.writeObject();
    }
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        // описание свойств, которые принимаются в десериализацию
        speech = in.readUTF();
        rating = in.readInt();
        age = in.readInt();
        //files = (cast) in.readObject();
    }
}
